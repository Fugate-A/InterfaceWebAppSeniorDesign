...
(library Library_1
	...
	(symbolDef "HSMW-C170-U0000" (originalName "HSMW-C170-U0000")
	...
	(compDef "HSMW-C170-U0000" (originalName "HSMW-C170-U0000") (compHeader (numPins 2) (numParts 1) (refDesPrefix LED)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "HSMW-C170-U0000"))
		...
		(attr "Mouser Part Number" "630-HSMW-C170-U0000")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/Broadcom-Avago/HSMW-C170-U0000?qs=tMOYG%252Bw4%252BLwGyeHODzQdug%3D%3D")
		(attr "Manufacturer_Name" "Avago Technologies")
		(attr "Manufacturer_Part_Number" "HSMW-C170-U0000")
		(attr "Description" "BROADCOM LIMITED - HSMW-C170-U0000 - LED, WHITE, 670MCD, 0805")
		(attr "<Hyperlink>" "https://componentsearchengine.com/Datasheets/2/HSMW-C170-U0000.pdf")
		(attr "<Component Height>" "0.9")
		(attr "<STEP Filename>" "HSMW-C170-U0000.stp")
